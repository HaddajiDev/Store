...
function Spawn_Cell(index, value){
    ...
    price += parseFloat(Current_price) * value;
    document.getElementById("Tot-cart").innerHTML = price.toFixed(2) + "$";
    document.getElementById("Tot-cart-final").innerHTML = (price + 10).toFixed(2) + "$"
